...
const isFinished = require('./bookUtils');
...
const getAllBooksHandler = (request, h) => {
  ...
  if (request.query.reading) {
    ...
    booksFiltered = books.filter((book) => book.reading === readingStatus);
  }
  if (request.query.finished) {
    const finishedStatus = request.query.finished === '1';
    booksFiltered = books.filter((book) => book.finished === finishedStatus);
  }
